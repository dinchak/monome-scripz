...
module.exports = class MidiLooper2 extends GridScript {
  ...
  setScaleNotesOn(type, note, instrument) {
    if (type == 'noteon') {
  ...
  setChordNotesOn(type, note, instrument) {
    if (type == 'noteon') {
